...
const path = './modules/emails/EmailTemplatesManager.tsx';
if (fs.existsSync(path)) {
  ...
  const replacements = [
    ...
    { from: /\bborder-gray-200\b/g, to: "border-border/60" },
    { from: /\bbg-gray-50\b/g, to: "bg-muted/30" },
  ];
  ...
  console.log('Fixed classes in templates!');
}
